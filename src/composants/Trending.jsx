    ...
    return (
        <section className="px-6 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                {restaurants.map((r) => (
                    <div key={r.id} className="relative group rounded-lg overflow-hidden bg-gray-200 shadow-lg w-full md:w-[280px] aspect-[280/420]">
                        ...
                        <div className="absolute inset-0 bg-light-black/25 backdrop-blur-xs text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-4 h-full">
                            ...
                            <div className="flex flex-col items-center gap-2 py-2">
                                <div className="flex justify-center gap-6">
                                    <WatchLaterIcon className="text-white hover:text-light-black transition-colors"/>
                                    <FavoriteIcon className="text-white hover:text-light-black transition-colors"/>
                                    <LocalDiningIcon className="text-white hover:text-light-black transition-colors"/>
                                </div>
