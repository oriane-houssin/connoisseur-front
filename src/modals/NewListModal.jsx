...
export default function NewListModal({isOpen, onClose, onSubmit, error}) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md relative border border-gray-700">
                ...
                />
                <h2 className="text-2xl font-bold mb-4 text-white">Créer une nouvelle liste</h2>
                {error && <p className="text-red-500 mb-4 text-sm">{error}</p>}

                <div className="mb-4">
                    <label htmlFor="newList_name" className="block text-gray-300 text-sm font-bold mb-2">
                        Nom de la liste:
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-6">
                    <label htmlFor="newList_description" className="block text-gray-300 text-sm font-bold mb-2">
                        Description (optionnel):
                    </label>
                    <textarea
                        id="newList_description"
                        name="description"
